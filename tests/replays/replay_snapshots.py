...
SYMBOLS: List[str] = ['HDFCBANK', 'HEROMOTOCO', 'HINDALCO', 'HINDZINC', 'ICICIBANK', 'INDIGO', 'INDUSINDBK', 'INFY', 'JINDALSTEL', 'JSWSTEEL', 'JUBLFOOD', 'KALYANKJIL', 'KOTAKBANK', 'LAURUSLABS', 'LICHSGFIN']
