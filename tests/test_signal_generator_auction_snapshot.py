...
def _stock_context() -> StockContextProjection:
    return StockContextProjection.model_validate({
        ...
        "accepted_range_id": "RANGE:test",
        "accepted_range_source": "INTRADAY_BALANCE",
        "accepted_range_low": 1499.0,
        "accepted_range_high": 1501.0,
        "accepted_range_established_at": TS,
        "accepted_range_provisional": False,
        "accepted_range_breakout_eligible": True,
        "accepted_range_inside": False,
        "accepted_range_position": -0.65,
        "accepted_range_outside_atr": 0.13,
        "session_open_price": 1505.0,
        "session_high_price": 1510.0,
        "session_high_time": TS,
        "session_low_price": 1497.0,
        "session_low_time": TS,
        "session_position": 0.05,
        "distance_to_session_high_atr": 1.23,
        "distance_to_session_low_atr": 0.07,
        "rise_from_session_low_atr": 0.07,
        "rise_from_session_low_pct": 0.0005,
        "decline_from_session_high_atr": 1.23,
        "decline_from_session_high_pct": 0.0081,
        "path_from_session_low_bars": 0,
        "path_from_session_low_efficiency": None,
        "path_from_session_low_directional_ratio": None,
        "path_from_session_high_bars": 6,
        "path_from_session_high_efficiency": 0.75,
        "path_from_session_high_directional_ratio": 0.80,
        "exhaustion_active": False,
        "exhausted_side": "UNKNOWN",
        "exhaustion_started_at": None,
        "exhaustion_expires_at": None,
        "reason_codes": ["TEST_OBJECTIVE_CONTEXT"],
    })
