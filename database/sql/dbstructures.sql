...
--
-- Table structure for table `stock_rank`
--
...
CREATE TABLE `stock_rank` (
  ...
  `attention_tier` varchar(16) NOT NULL DEFAULT 'SUPPRESSED',
...
) ENGINE=InnoDB AUTO_INCREMENT=4773 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `stock_rank_history`
--

DROP TABLE IF EXISTS `stock_rank_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `stock_rank_history` (
  `history_id` bigint NOT NULL AUTO_INCREMENT,
